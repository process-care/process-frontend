...
import { DELETE_FILE, UPLOAD_FILE_MULTIPLE, UPLOAD_FILE_SINGLE } from "api/queries";
...
export const useUploadFileSingle = (): UseMutationResult<any, Error> =>
  useMutation<any, Error, any>(
    async (params: UploadSingleParams) => await request(API_URL, UPLOAD_FILE_SINGLE, params),
    optimisticUpdate(["getLanding"]),
  );

export const useUploadFileMultiple = (): UseMutationResult<any, Error> =>
useMutation<any, Error, any>(
  async (params: UploadMultipleParams) => await request(API_URL, UPLOAD_FILE_MULTIPLE, params),
  optimisticUpdate(["getLanding"]),
);
