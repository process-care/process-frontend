            ...
            <Flex px="12%" py="10%" >
                {had_media && (
                    <Box w="100%">
                        ...
                        {had_image && <img src={data.image_cover} style={{ maxWidth: "400px", width: "400px" }} alt="" />}
                    </Box>
                )}
                <Box w={had_media ? '100%' : "80%"} m={had_media ? "inherit" : "auto"} pl={10}>
                    <Text textAlign="left" variant="xxs" dangerouslySetInnerHTML={{ __html: data.wysiwyg || big_placeholder }}></Text>
